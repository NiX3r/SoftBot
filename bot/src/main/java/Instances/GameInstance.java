...
public class GameInstance {
    ...
    public GameInstance(int id, String name, String thumbnail, long start_date, long end_date, String repeat_date, String website, String location, float price, String type, String description, GameStatusEnum status, long last_edit_date, long last_edit_user_id, GameStatusEnum last_edit_status, long create_date){
